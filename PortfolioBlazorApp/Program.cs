...
namespace PortfolioBlazorApp
{
    ...
    { 
        ...
        {
            this.ConfigureHandler(authorizedUrls: new[] { config["Endpoint Base Address"], "https://localhost:5001", "https://wyattbrown23.github.io/Portfolio/", "https://myportfolio-wyattb.herokuapp.com/" });
        }
